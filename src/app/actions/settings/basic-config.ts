 ...
 */
export const updateBasicConfig = withAuth(
    async (data: BasicConfig): Promise<Result<BasicConfig>> => {
        try {
            // Read current config
            ...
            return {
                ...
                message:
                    error instanceof Error
                        ? error.message
                        : "Failed to update basic configuration",
                payload: {} as BasicConfig,
            };
        }
    }
 ...
 */
export const getBasicConfig = withAuth(
    async (): Promise<Result<BasicConfig>> => {
        try {
