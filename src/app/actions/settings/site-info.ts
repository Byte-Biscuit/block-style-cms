 ...
 */
export const updateSiteInfo = withAuth(
    async (data: SiteInfoConfig): Promise<Result<SiteInfoConfig>> => {
        try {
            // Read current config
 ...
 */
export const getSiteInfo = withAuth(
    async (): Promise<Result<SiteInfoConfig>> => {
        try {
 ...
 */
export const uploadLogo = withAuth(
    async (formData: FormData): Promise<Result<string>> => {
        try {
