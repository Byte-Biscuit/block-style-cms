...
export const SUGGESTION_DIR = BASE_DATA_PATH
    ? `${BASE_DATA_PATH}/suggestions`
    : "";
...
// File size limits
export const MAX_FILE_SIZE = 5 * 1024 * 1024; // 5MB (cover images)
export const MAX_ATTACHMENT_SIZE = 50 * 1024 * 1024; // 50MB (file-block attachments)
